...
public class ResultActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Integer imageFileID[] = {R.drawable.cry, R.drawable.monalisa, R.drawable.napoleon, R.drawable.night, R.drawable.pearl,
        R.drawable.self, R.drawable.sunflower, R.drawable.tiger, R.drawable.women};
        ...
        resultTv.setText(imageName[top]);
        resultIv.setImageResource(imageFileID[top]);
